# APA-Tech OpenShift Introduction

## Code Samples

1. [Pod](code-samples/example-01-pod/)
2. [ConfigMap](code-samples/example-02-configmap/)
3. [ReplicaSet](code-samples/example-03-rs/)
4. [Deployment](code-samples/example-04-deployment/)
5. [Service](code-samples/example-05-service/)
